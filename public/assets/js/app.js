...
$('.sponsore').slick({
  ...
  nextArrow: '<div class="slick-next "><i class="fas fa-long-arrow-right"></i></div>',
  slidesToScroll: 3
});
...
/*
function vitax_blog_tm_modalbox_portfolio(){
    
    "use strict";
    
    var modalBox    = jQuery('.vitax_blog_tm_modalbox');
...
function vitax_blog_tm_modalbox_news(){
    
    "use strict";
    
    var modalBox    = jQuery('.vitax_blog_tm_modalbox');
    var list        = jQuery('.vitax_blog_tm_news .row .row-col');
    var closePopup  = modalBox.find('.close');
